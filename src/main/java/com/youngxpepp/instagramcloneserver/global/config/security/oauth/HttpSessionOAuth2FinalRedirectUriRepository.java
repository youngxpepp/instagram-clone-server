...
@Component
public class HttpSessionOAuth2FinalRedirectUriRepository implements OAuth2FinalRedirectUriRepository {

	private static final String FINAL_REDIRECT_URI_ATTR_NAME =
		HttpSessionOAuth2FinalRedirectUriRepository.class.getName() + ".FINAL_REDIRECT_URI";
	...
	public void saveFinalRedirectUri(OAuth2AuthorizationRequest authorizationRequest, HttpServletRequest request) {
		...
		Map<String, String> finalRedirectUriMap = getFinalRedirectUriMap(request);
